// js/main.js
// Application controller — imports all modules and initialises features.
// Retains the production-safe runAfterReady + safeRun architecture.

import { CONFIG } from './config.js';
import { searchCatalog, detailedServices, pdfTemplates, pricingConfig, addonRates } from './data/business-data.js';
import { escapeHtml, normalizeText, toLookupKey, normalizePhoneNumber, resolveBusinessWhatsAppNumber, resolveBusinessEmail } from './utils/helpers.js';
